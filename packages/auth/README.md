...
A production-ready authorization framework that adds capability-based access control, TOCTOU prevention, and intent alignment to AI agent tool execution.
